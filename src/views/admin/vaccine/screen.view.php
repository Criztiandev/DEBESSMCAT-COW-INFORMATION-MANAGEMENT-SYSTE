...
<main class="p-4 md:ml-64 h-auto pt-20 overflow-hidden">
    <section class="">
        <?php echo $error ?>
        <div class=" h-full">
            <div class="bg-white dark:bg-gray-800 relative  sm:rounded-lg overflow-hidden overflow-y-scroll h-full ">
                <div
                    ...
                    <div
                        ...
                        <a href="/vaccine/create" type="button"
                ...
                <div class="overflow-x-auto" style="height: calc(100vh - 240px);">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-3">Cow ID</th>
                            ...
                            <?php foreach ($vaccine as $items): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class=" flex justify-center items-center">
                                        ...
                                        <a href="/vaccine/update?id=<?= $items["COW_ID"] ?>" type="button"
                                        ...
                                        <button id="delete-backdrop" type="button" value="<?= $items["COW_ID"] ?>"
                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg xmlns='http://www.w3.org/2000/svg' width='18' height='18'
                                                viewBox='0 0 24 24'>
...
<?php display("helper/components/ui/DeleteModal.php", ["route" => "/vaccine/delete"]); ?>
