            ...
            <div class="bg-white dark:bg-gray-800 relative  sm:rounded-lg  overflow-y-scroll h-full ">
                <div
                    ...
                    <div
                        ...
                        <a href="/feed/create" type="button"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Feed Type</th>
                            ...
                            <?php foreach ($payload as $item): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class=" flex justify-center items-center">
                                        ...
                                        <a href="/feed/update?id=<?= $item["COW_ID"] ?>" type="button"
                                        ...
                                        <button id="delete-backdrop" type="button" value="<?= $item["COW_ID"] ?>"
                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg xmlns='http://www.w3.org/2000/svg' width='18' height='18'
                                                viewBox='0 0 24 24'>
...
<?php display("helper/components/ui/DeleteModal.php", [
    "route" => "/feed/delete"
]); ?>
