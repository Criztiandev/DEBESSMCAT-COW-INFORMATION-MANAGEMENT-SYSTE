            ...
            <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-y-scroll h-full ">
                <div
                    ...
                    <div
                        ...
                        <a href="/staff/create" type="button"
                            ...
                            <?php foreach ($payload as $items): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class=" flex justify-center items-center">
                                        ...
                                        <button id="delete-backdrop" type="button" value="<?= $items["ID"] ?>"
...
<?php display("helper/components/ui/DeleteModal.php", ["route" => "/staff/delete"]); ?>
