    ...
    <div class="flex items-center justify-between">
        <div class="flex justify-start items-center">
            ...
            <a href="/" class="flex items-center justify-between mr-4">
                <span class="self-center text-2xl font-semibold whitespace-nowrap  ">COW MANAGEMENT SYSTEM</span>
            </a>
        </div>
        ...
        <div class="relative" id="dropdown">
            <button id="avatar">
                <img class="w-10 h-10 rounded-full"
                    src="https://eu.ui-avatars.com/api/?name=<?= $_SESSION['user']["FULL_NAME"] ?>size=250"
                    alt="profile">
            </button>
            <div id="dropdown-content"
                ...
                <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                    ...
                    <div class="font-medium truncate"><?= $_SESSION['user']["EMAIL"] ?></div>
                </div>
